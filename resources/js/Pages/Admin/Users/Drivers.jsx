...
export default function Drivers({ drivers, filters, stats }) {
    ...
    const handleSearch = (e) => {
        ...
        router.get(route('admin.users.drivers'), { search, status: statusFilter }, { preserveState: true });
    };

    const handleTabChange = (status) => {
        setStatusFilter(status);
        router.get(route('admin.users.drivers'), { search, status }, { preserveState: true });
    };
