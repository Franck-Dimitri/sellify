    ...
    return (
        <AdminLayout title="Tableau de bord administration">
            ...
            <div className="w-full space-y-6 text-stone-800 antialiased font-sans pb-16">
                ...
                {/* SELLIFY AI 1.2 FLASH PROACTIVE ADMIN COPILOT BANNER */}
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-5 relative z-10">
                        <div className="space-y-1.5 max-w-xl">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-stone-400 text-xs font-medium">Copilote SuperAdmin & Arbitrage</span>
                            </div>
                            <h2 className="text-base font-bold text-white">
                                Détection d'anomalies financières, arbitrage des litiges et audit KYC en temps réel
                            </h2>
                            <p className="text-xs text-stone-300 font-normal leading-relaxed">
                                Interrogez Sellify AI pour auditer les flux Escrow, analyser les profils de fraudeurs potentiels ou générer des synthèses d'activité de la plateforme.
                            </p>
                        </div>
                        ...
                        <div className="flex flex-wrap items-center gap-2.5 shrink-0">
                            ...
                            >
                                ...
                                <span>Ouvrir Sellify AI SuperAdmin</span>
