...
import { Lock, ArrowRight, Eye, EyeOff, ShieldCheck, Mail } from 'lucide-react';
...
export default function ResetPassword({ token, email }) {
    ...
    return (
        <div className="min-h-screen bg-stone-50 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 font-sans text-stone-800">
            <Head title="Nouveau mot de passe - Sellify.me" />
            ...
            <div className="max-w-md w-full mx-auto space-y-6">
                ...
                <div className="bg-white border border-stone-200 rounded-2xl p-8 shadow-sm space-y-6">
                    <div className="text-center space-y-1.5">
                        <h1 className="text-2xl font-bold text-stone-900">Créer un nouveau mot de passe</h1>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4 text-xs">
                        ...
                        <div className="space-y-1.5">
                            <label className="font-semibold text-stone-700 block">Nouveau mot de passe</label>
                            <div className="relative">
                                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-stone-400">
                        ...
                        <div className="space-y-1.5">
                            <label className="font-semibold text-stone-700 block">Confirmer nouveau mot de passe</label>
                            <div className="relative">
                                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-stone-400">
                                    <Lock className="w-4 h-4" />
                                </div>
                ...
                <div className="text-center text-[11px] text-stone-400 flex items-center justify-center gap-1.5">
                    ...
                    <span>Sécurité garantie par Sellify Identity Protection</span>
                </div>
            </div>
        </div>
    );
