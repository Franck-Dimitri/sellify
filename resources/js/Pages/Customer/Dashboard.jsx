                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-5 relative z-10">
                        <div className="space-y-1.5 max-w-xl">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-stone-400 text-xs font-medium">Assistant Intelligent 24/7</span>
                            </div>
                            <h2 className="text-base font-bold text-white">
                                Besoin d'un suivi précis, d'un conseil produit ou d'une assistance litige ?
                            </h2>
                            <p className="text-xs text-stone-300 font-normal leading-relaxed">
                                Interrogez Sellify AI en langage naturel pour localiser vos colis, vérifier vos codes secrets OTP ou comprendre la protection séquestre Escrow.
                            </p>
                        </div>
                        ...
                        <div className="flex flex-wrap items-center gap-2.5 shrink-0">
                            ...
                            >
                                ...
                                <span>Ouvrir Sellify AI 1.2 Flash</span>
